...
local sheet8 = graphics.newImageSheet( "store/pendolm.png", {  width=160, height=110, numFrames=10} )

local sequenceData = { sheet=sheet8 ,name="man",start=1,count=10 ,time=2000  }
...
string="Beware of the inertia blades"
...
storyboard.gotoScene("storyboard 2.stage2","fade",100)
end
