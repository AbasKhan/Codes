...
local sky51 = display.newImageRect( "store/dark.png",500,200 )
sky51.x = 248; sky51.y = 550

local sky61 = display.newImageRect( "store/dark.png",500,200 )
sky61.x = 740; sky61.y = 550

local sky71 = display.newImageRect( "store/dark.png",500,200 )
sky71.x = 1100; sky71.y = 550

local sky72 = display.newImageRect( "store/dark.png",500,200 )
sky72.x = 1500; sky72.y = 550
...
gd = display.newImage( "store/down ground.png" )
gd.x = 500; gd.y = 500
...
gd.isVisible=false
gd1 = display.newImage( "store/down ground.png" )
gd1.x = 1045; gd1.y = 500
gd1.isVisible=false
gd1.myName="ground"
gd1.find="downground"
physics.addBody( gd1, "static", { friction=0.5, bounce=0.3 } )
...
strip = display.newImageRect( "store/strip.png",430,25 )
strip.x = 215; strip.y = 450
game:insert(strip)


strip1 = display.newImageRect( "store/strip.png",500,25 )
strip1.x = 650; strip1.y = 470
game:insert(strip1)

strip2 = display.newImageRect( "store/strip.png",500,25 )
strip2.x = 1140; strip2.y = 470
game:insert(strip2)


strip3 = display.newImageRect( "store/strip.png",500,25 )
strip3.x = 1630; strip3.y = 470
game:insert(strip3)
