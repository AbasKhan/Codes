...
local sheet8 = graphics.newImageSheet( "store/virneir12.png", {  width=177, height=122, numFrames=7} )

local sequenceData = { sheet=sheet8 ,name="man",start=1,count=7 ,time=1000  }
...
string="Use vernier Caliper to measure keys"
...
string1="vernier Caliper is used to measure the diameter of an Object"
...
storyboard.gotoScene("vernier","fade",100)
end
