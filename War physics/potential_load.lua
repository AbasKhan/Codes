...
local sheet8 = graphics.newImageSheet( "store/poten.png", {  width=224, height=156, numFrames=6} )

local sequenceData = { sheet=sheet8 ,name="man",start=1,count=10 ,time=3000 ,loopCount = 1 }
...
string="Objects Possess potential Energy due to their position"
...
text.y=280
--game:insert(text)
string1="Energy is the ability of a body to do work"
...
storyboard.gotoScene("potential","fade",100)
end
