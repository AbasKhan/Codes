...
local sheet8 = graphics.newImageSheet( "store/vir_anim2.png", {  width=228, height=156, numFrames=10} )

local sequenceData = { sheet=sheet8 ,name="man",start=1,count=10 ,time=2500 ,loopCount = 1 }
...
string="find the right key to open doors using Vernier calliper"
...
string1="Vernier Caliper is a measuring device "
