...
storyboard.gotoScene("storyboard 2.stage2",sceneChangeEffect, sceneChangeTime)

end


function replay(event)
storyboard.gotoScene("game",sceneChangeEffect, sceneChangeTime)
