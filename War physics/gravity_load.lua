...
local sheet8 = graphics.newImageSheet( "store/gravity.png", {  width=224, height=156, numFrames=6} )

local sequenceData = { sheet=sheet8 ,name="man",start=1,count=10 ,time=3000  }
...
string="Beware of the gravity spikes"
...
string1="Gravity is the force that attracts a body towards the centre of the earth"

text1= display.newText(string1, 0,0, 250,0,"Comic Sans MS", 12);
text1.x=250
text1.y=70
...
storyboard.gotoScene("thrd","fade",100)
end
