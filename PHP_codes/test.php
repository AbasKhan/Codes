...
elseif(!empty($_POST['username']) && !empty($_POST['password']))
{
    ...
    $password = $_POST['password'];
	 ...
	 $checklogin = mysql_query("SELECT * FROM users WHERE EmailAddress ='$username'AND Password='$password'");
...
else
{
   ...
   <p>Thanks for visiting! Please either login below, or <a href="register.php">click here to register</a>.</p>
    ...
    <form method="post" action="test.php" name="loginform" id="loginform"> <!--onsubmit="return check()"-->
	<fieldset>
